...
public class RentalLocationRepoImpl implements RentalLocationRepo{
	...
	public RentalLocation getById(Integer id) {
		return this.template.queryForObject(SELECT_ROW, new Object[]{id}, new org.springframework.jdbc.core.RowMapper<RentalLocation>(){

			public RentalLocation mapRow(ResultSet rs, int rowNum)
					throws SQLException {
